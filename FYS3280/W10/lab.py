...
#     plt.plot(values, y, label = f"LinReg: {np.log10(np.exp(regression.slope)):.2f}V {np.log10(np.exp(regression.intercept)):.2f}", linestyle='--')

#     # Set labels and title
#     plt.title("IV Curve linear regression") 
#     plt.yscale("log")
#     plt.xlim(0, 1)
#     plt.xlabel("Bias [V]")
#     plt.ylabel("I [A]")
